...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        sucess_counts = filtered_df['class'].value_counts().reset_index()
        sucess_counts.columns = ['class', 'count']

        fig = px.pie(sucess_counts, values='count', names='class', title=f'Sucess vs Failure  for {entered_site}')
    return fig
# TASK 4:
...
def get_scatter_plot(entered_site, payload_range):
    # Filtrar os dados com base no intervalo do slider
